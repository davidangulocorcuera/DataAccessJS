...
if(isset($parameters)){
	...
	if(JSONCorrectoAnnadir($mensajeRecibido)){
		...
		$query  = "INSERT INTO  personas (ID,Nombre,CaracteristicaUno,CaracteristicaDos,CaracteristicaTres,ID_curso) ";
		$query .= "VALUES ('$id','$name','$first_characteristic','$second_characteristic','$third_characteristic', '$id_curse')";
