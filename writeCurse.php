...
if(isset($parameters)){
	...
	if(JSONCorrectoAnnadir($mensajeRecibido)){
		...
		$query  = "INSERT INTO  curso (ID,Nombre,CaracteristicaUno,CaracteristicaDos,CaracteristicaTres) ";
		$query .= "VALUES ($id,'$name','$first_characteristic','$second_characteristic','$third_characteristic')";
